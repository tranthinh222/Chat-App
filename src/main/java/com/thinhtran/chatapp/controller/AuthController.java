...
import com.thinhtran.chatapp.domain.request.*;
import com.thinhtran.chatapp.domain.response.ResLoginDto;
import com.thinhtran.chatapp.domain.response.ResUserDto;
import com.thinhtran.chatapp.domain.response.ResUserJwtDto;
import com.thinhtran.chatapp.domain.response.ResVerifyOtpDto;
import com.thinhtran.chatapp.service.AuthService;
...
import com.thinhtran.chatapp.util.error.ApiException;
...
public class AuthController {
    ...
    @Value("${thinhtran.jwt.refresh-token-validity-in-seconds}")
